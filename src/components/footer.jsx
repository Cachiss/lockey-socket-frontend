...
export const Footer = () => {
  return (
    <footer class="bg-white rounded-lg shadow dark:bg-gray-800 h-20 flex flex-col items-center justify-center absolute right-0 left-0 bottom-0">
        <div class="w-full mx-auto max-w-screen-xl  md:flex md:items-center md:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Lockey™</a>. Todos los derechos reservados.
        </span>
